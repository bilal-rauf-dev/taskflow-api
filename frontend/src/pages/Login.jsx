  ...
  return (
    <div className="page-enter min-h-screen bg-background">
      <div className="grid min-h-screen lg:grid-cols-[1.05fr_0.95fr]">
          <aside className="relative hidden overflow-hidden border-r-2 border-foreground bg-tertiary p-10 text-foreground lg:flex lg:flex-col lg:justify-between">
          <div className="dot-field absolute inset-0 opacity-20" />
          <div className="absolute -left-20 bottom-8 h-72 w-72 rounded-full border-2 border-foreground bg-secondary" />
          <div className="relative">
            <div className="mb-10 flex items-center gap-3">
              <div className="grid h-12 w-12 place-items-center rounded-full border-2 border-foreground bg-accent text-white shadow-pop">
                <EnvelopeIcon className="h-5 w-5" strokeWidth={2.5} />
              </div>
              <div>
                <p className="font-heading text-3xl font-extrabold">TaskFlow</p>
                <p className="text-sm font-semibold text-foreground/70">Secure work, happily organized.</p>
              </div>
            </div>
            <h1 className="qp-heading max-w-md text-5xl leading-tight">Pick up where your momentum left off.</h1>
            <p className="mt-5 max-w-lg text-base font-medium leading-7 text-foreground/70">
              Sign in to a workspace that keeps priorities clear, progress visible, and task management refreshingly human.
            </p>
          </div>
        ...
        <section className="flex items-center justify-center bg-background px-4 py-10 sm:px-6 lg:px-10">
          <div className="flex w-full max-w-md flex-col justify-center py-2 animate-fade-in lg:py-8">
            ...
            <div className="qp-card relative p-6 shadow-pink sm:p-8">
              <span className="absolute -right-4 -top-4 h-8 w-8 rotate-12 border-2 border-foreground bg-quaternary" aria-hidden="true" />
              <div className="mb-6">
